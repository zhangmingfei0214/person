...
<div class="loginBox">
	<div class="login_cont">
		<ul class="login">
				...
				<li class="mb_10"><input type="text" name="passsword" class="login_input user_icon"></li><br/>
				<li class="auto"><input type="checkbox" id="a1" class="checked" for="a1"/>自动登录</li><br/>
...
<div class="footer">
	...
	<a href="#"><img src="${ pageContext.request.contextPath }/images/webLogo.jpg" alt="logo"></a>
	<a href="#"><img src="${ pageContext.request.contextPath }/images/webLogo.jpg" alt="logo"></a>
	<a href="#"><img src="${ pageContext.request.contextPath }/images/webLogo.jpg" alt="logo"></a></p>
</div>
</body>
</html>
